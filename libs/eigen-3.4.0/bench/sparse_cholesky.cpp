...
void
fillSpdMatrix(float density, int rows, int cols, EigenSparseSelfAdjointMatrix& dst)
{
...
void
doEigen(const char* name, const EigenSparseSelfAdjointMatrix& sm1, int flags = 0)
{
