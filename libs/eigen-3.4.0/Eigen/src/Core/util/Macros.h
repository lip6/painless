...
#define EIGEN_GENERIC_PUBLIC_INTERFACE(Derived)                                                                        \
	...
	typedef typename Eigen::NumTraits<Scalar>::Real                                                                    \
		RealScalar; /*!< \brief The underlying numeric type for composed scalar types. \details In cases where Scalar  \
	...
	typedef typename Base::CoeffReturnType                                                                             \
		CoeffReturnType; /*!< \brief The return type for coefficient access. \details Depending on whether the object  \
							allows direct coefficient access (e.g. for a MatrixXd), this type is either 'const         \
							Scalar&' or simply 'Scalar' for objects that do not allow direct coefficient access. */    \
...
#define EIGEN_SCALAR_BINARY_SUPPORTED(OPNAME, TYPEA, TYPEB)                                                            \
	(Eigen::internal::has_ReturnType<                                                                                  \
		 Eigen::ScalarBinaryOpTraits<TYPEA,                                                                            \
									 TYPEB,                                                                            \
...
#define EIGEN_MAKE_SCALAR_BINARY_OP_ONTHERIGHT(METHOD, OPNAME)                                                         \
	...
	{                                                                                                                  \
		typedef                                                                                                        \
			typename internal::promote_scalar_arg<Scalar, T, EIGEN_SCALAR_BINARY_SUPPORTED(OPNAME, Scalar, T)>::type   \
				PromotedT;                                                                                             \
...
#define EIGEN_MAKE_SCALAR_BINARY_OP_ONTHELEFT(METHOD, OPNAME)                                                          \
	...
	{                                                                                                                  \
		typedef                                                                                                        \
			typename internal::promote_scalar_arg<Scalar, T, EIGEN_SCALAR_BINARY_SUPPORTED(OPNAME, T, Scalar)>::type   \
				PromotedT;                                                                                             \
