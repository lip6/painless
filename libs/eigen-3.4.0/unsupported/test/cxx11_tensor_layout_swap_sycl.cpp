...
static void
test_simple_swap_sycl(const Eigen::SyclDevice& sycl_device)
{
...
template<typename DataType, typename IndexType>
static void
test_swap_as_lvalue_sycl(const Eigen::SyclDevice& sycl_device)
{
...
void
sycl_tensor_layout_swap_test_per_device(dev_Selector s)
{
