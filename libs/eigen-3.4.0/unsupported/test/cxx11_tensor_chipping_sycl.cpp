...
static void
test_static_chip_sycl(const Eigen::SyclDevice& sycl_device)
{
...
template<typename DataType, int DataLayout, typename IndexType>
static void
test_dynamic_chip_sycl(const Eigen::SyclDevice& sycl_device)
{
	IndexType sizeDim1 = 2;
	IndexType sizeDim2 = 3;
	IndexType sizeDim3 = 5;
...
template<typename DataType, int DataLayout, typename IndexType>
static void
test_chip_in_expr(const Eigen::SyclDevice& sycl_device)
{
...
template<typename DataType, int DataLayout, typename IndexType>
static void
test_chip_as_lvalue_sycl(const Eigen::SyclDevice& sycl_device)
{
...
void
sycl_chipping_test_per_device(dev_Selector s)
{
