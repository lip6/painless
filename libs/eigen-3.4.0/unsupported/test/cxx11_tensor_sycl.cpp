...
void
test_sycl_mem_transfers(const Eigen::SyclDevice& sycl_device)
{
...
template<typename DataType, int DataLayout, typename IndexType>
void
test_sycl_mem_sync(const Eigen::SyclDevice& sycl_device)
{
	IndexType size = 20;
...
template<typename DataType, int DataLayout, typename IndexType>
void
test_sycl_mem_sync_offsets(const Eigen::SyclDevice& sycl_device)
{
...
template<typename DataType, int DataLayout, typename IndexType>
void
test_sycl_memset_offsets(const Eigen::SyclDevice& sycl_device)
{
	using tensor_type = Tensor<DataType, 1, DataLayout, IndexType>;
	IndexType full_size = 32;
	IndexType half_size = full_size / 2;
...
template<typename DataType, int DataLayout, typename IndexType>
void
test_sycl_computations(const Eigen::SyclDevice& sycl_device)
{
...
static void
test_sycl_cast(const Eigen::SyclDevice& sycl_device)
{
	IndexType size = 20;
	array<IndexType, 1> tensorRange = { { size } };
