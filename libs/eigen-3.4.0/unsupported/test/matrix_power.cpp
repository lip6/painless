...
template<typename T>
void
test2dHyperbolicRotation(const T& tol)
{
...
void
testGeneral(const MatrixType& m, const typename MatrixType::RealScalar& tol)
{
...
template<typename MatrixType>
void
testSingular(const MatrixType& m_const, const typename MatrixType::RealScalar& tol)
{
...
template<typename MatrixType>
void
testLogThenExp(const MatrixType& m_const, const typename MatrixType::RealScalar& tol)
{
	// we need to pass by reference in order to prevent errors with
	// MSVC for aligned data types ...
	MatrixType& m = const_cast<MatrixType&>(m_const);
