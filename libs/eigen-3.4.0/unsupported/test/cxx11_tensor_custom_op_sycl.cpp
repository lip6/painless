...
static void
test_custom_unary_op_sycl(const Eigen::SyclDevice& sycl_device)
{
...
template<typename DataType, int DataLayout, typename IndexType>
static void
test_custom_binary_op_sycl(const Eigen::SyclDevice& sycl_device)
{
...
void
custom_op_perDevice(Dev_selector s)
{
