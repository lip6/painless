...
Scalar
stem_function_exp(Scalar x, int)
{
	using std::exp;
	return exp(x);
}
...
template<typename Scalar>
Scalar
stem_function_cos(Scalar x, int n)
{
	using std::cos;
	using std::sin;
	Scalar res;
...
template<typename Scalar>
Scalar
stem_function_sin(Scalar x, int n)
{
	using std::cos;
	using std::sin;
	Scalar res;
...
template<typename Scalar>
Scalar
stem_function_cosh(Scalar x, int n)
{
	using std::cosh;
	using std::sinh;
	Scalar res;
...
template<typename Scalar>
Scalar
stem_function_sinh(Scalar x, int n)
{
	using std::cosh;
	using std::sinh;
	Scalar res;
