...
static inline djb_t*
djb_init(rci_t nrows, rci_t ncols)
{
...
static inline void
djb_push_back(djb_t* z, rci_t target, rci_t source, srctyp_t srctyp)
{
...
void
djb_apply_mzd(djb_t* z, mzd_t* W, const mzd_t* V);
