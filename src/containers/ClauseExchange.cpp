...
ClauseExchange::ClauseExchange(const csize_t size_,
                               const lbd_t lbd_,
                               const plid_t from_)
  : lbd(lbd_)
  , from(from_)
...
ClauseExchangePtr
ClauseExchange::create(const csize_t size, const lbd_t lbd, const plid_t from)
{
...
ClauseExchangePtr
ClauseExchange::create(clause_view_t v_cls, const lbd_t lbd, const plid_t from)
{
