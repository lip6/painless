...
#ifdef LOGGING
KITTEN_VISIBILITY void kitten_set_logging (kitten *kitten) { logging = true; }
#endif
...
KITTEN_VISIBILITY uint64_t kitten_current_ticks (kitten *kitten) {
  REQUIRE_INITIALIZED ();
...
KITTEN_VISIBILITY void kitten_no_terminator (kitten *kitten) {
  REQUIRE_INITIALIZED ();
...
KITTEN_VISIBILITY void kitten_set_terminator (kitten *kitten, void *data,
                            int (*terminator) (void *)) {
  REQUIRE_INITIALIZED ();
...
KITTEN_VISIBILITY void kitten_assume_signed (kitten *kitten, int elit) {
...
KITTEN_VISIBILITY void kitten_trace_core (kitten *kitten, void *state,
...
KITTEN_VISIBILITY signed char kitten_signed_value (kitten *kitten, int selit) {
  REQUIRE_STATUS (10);
...
KITTEN_VISIBILITY signed char kitten_fixed_signed (kitten *kitten, int elit) {
  unsigned kelit = int2u (elit);
...
KITTEN_VISIBILITY bool kitten_flip_signed_literal (kitten *kitten, int elit) {
  REQUIRE_STATUS (10);
  unsigned kelit = int2u (elit);
...
KITTEN_VISIBILITY int kitten_flip_and_implicant_for_signed_literal (kitten *kitten,
                                                  int elit) {
  REQUIRE_STATUS (10);
  unsigned kelit = int2u (elit);
