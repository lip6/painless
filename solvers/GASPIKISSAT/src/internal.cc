...
void gaspi::kissat_release(kissat *solver)
{
...
void gaspi::kissat_reserve(kissat *solver, int max_var)
{
  kissat_require_initialized(solver);
...
int gaspi::kissat_get_option(kissat *solver, const char *name)
{
  kissat_require_initialized(solver);
...
int gaspi::kissat_set_option(kissat *solver, const char *name, int new_value)
{
#ifndef NOPTIONS
  kissat_require_initialized(solver);
  kissat_require(name, "name zero pointer");
...
void gaspi::kissat_set_decision_limit(kissat *solver, unsigned limit)
{
  kissat_require_initialized(solver);
...
void gaspi::kissat_set_conflict_limit(kissat *solver, unsigned limit)
{
  kissat_require_initialized(solver);
  limits *limits = &solver->limits;
  limited *limited = &solver->limited;
...
void gaspi::kissat_print_statistics(kissat *solver)
{
#ifndef QUIET
  kissat_require_initialized(solver);
...
void gaspi::kissat_add(kissat *solver, int elit)
{
  kissat_require_initialized(solver);
...
int gaspi::kissat_solve(kissat *solver)
{
  kissat_require_initialized(solver);
...
void gaspi::kissat_terminate(kissat *solver)
{
  kissat_require_initialized(solver);
...
int gaspi::kissat_value(kissat *solver, int elit)
{
  kissat_require_initialized(solver);
  kissat_require_valid_external_internal(elit);
