...
test_init_add_release (void)
{
  ...
  for (int check = 0; check <= max_check; check++)
    {
      kissat *solver = new_solver ();
      gaspi::kissat_set_option(solver, "log", 4);
#ifndef NDEBUG
      gaspi::kissat_set_option(solver, "check", check);
#endif
      gaspi::kissat_add (solver, 2);
      gaspi::kissat_add (solver, -12);
      gaspi::kissat_add (solver, 0);
      gaspi::kissat_add (solver, -17);
      gaspi::kissat_add (solver, -2);
      gaspi::kissat_add (solver, 0);
      ...
      gaspi::kissat_add (solver, 1);
      gaspi::kissat_add (solver, 0);
      gaspi::kissat_add (solver, 7);
      gaspi::kissat_add (solver, 8);
      gaspi::kissat_add (solver, 7);
      gaspi::kissat_add (solver, 8);
      gaspi::kissat_add (solver, 7);
      gaspi::kissat_add (solver, 0);
      ...
      gaspi::kissat_add (solver, -7);
      gaspi::kissat_add (solver, 0);
      gaspi::kissat_add (solver, 9);
      gaspi::kissat_add (solver, 7);
      gaspi::kissat_add (solver, 0);
      if (tissat_big)
	{
	  gaspi::kissat_add (solver, EXTERNAL_MAX_VAR);
	  gaspi::kissat_add (solver, 0);
	}
      gaspi::kissat_release(solver);
    }
