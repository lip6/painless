...
void
kissat_init_profiles(profiles*);
void
kissat_profiles_print(struct kissat*);
void
kissat_start(struct kissat*, profile*);
void
kissat_stop(struct kissat*, profile*);

void
kissat_stop_search_and_start_simplifier(struct kissat*, profile*);
void
kissat_stop_simplifier_and_resume_search(struct kissat*, profile*);

double
kissat_time(struct kissat*);
