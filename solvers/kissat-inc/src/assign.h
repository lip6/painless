...
void kissat_inc_assign_unit (struct kissat *, unsigned lit);
void kissat_inc_assign_decision (struct kissat *, unsigned lit);

void kissat_inc_assign_binary (struct kissat *, bool, unsigned, unsigned);

void kissat_inc_assign_reference (struct kissat *, unsigned lit,
