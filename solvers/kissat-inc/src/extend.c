...
undo_eliminated_assignment (kissat * solver)
{
  ...
  LOG ("unassigning %zu eliminated variables %.0f%%",
       size_etrail, kissat_inc_percent (size_etrail, size_eliminated));
...
kissat_inc_extend (kissat * solver)
{
  ...
  LOG ("assigned %zu external variables %.0f%% out of %zu eliminated",
       assigned, kissat_inc_percent (assigned, total), total);
  LOG ("flipped %zu external variables %.0f%% out of %zu assigned",
       flipped, kissat_inc_percent (flipped, assigned), assigned);
