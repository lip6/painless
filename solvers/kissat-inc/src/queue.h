...
void kissat_inc_init_queue (queue *);
void kissat_inc_enqueue (struct kissat *, unsigned idx);
void kissat_inc_dequeue (struct kissat *, unsigned idx);
void kissat_inc_move_to_front (struct kissat *, unsigned idx);
