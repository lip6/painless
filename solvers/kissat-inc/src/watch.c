...
void
kissat_inc_remove_blocking_watch (kissat * solver,
...
void
kissat_inc_flush_large_watches (kissat * solver)
{
  assert (solver->watching);
...
void
kissat_inc_watch_large_clauses (kissat * solver)
{
...
void
kissat_inc_connect_irredundant_large_clauses (kissat * solver)
{
  assert (!solver->watching);
...
void
kissat_inc_flush_large_connected (kissat * solver)
{
  assert (!solver->watching);
