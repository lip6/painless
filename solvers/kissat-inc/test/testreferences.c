...
do { \
    ...
    kissat_inc_push_binary_watch (solver, &watches, true, false, 0);
    kissat_inc_push_blocking_watch (solver, &watches, 1, 0);
    kissat_inc_push_binary_watch (solver, &watches, false, false, 2);
    kissat_inc_push_blocking_watch (solver, &watches, 3, 1);
    kissat_inc_push_binary_watch (solver, &watches, true, false, 4);
    kissat_inc_push_binary_watch (solver, &watches, false, false, 5);
    ...
    kissat_inc_push_large_watch (solver, &watches, 0);
    kissat_inc_push_large_watch (solver, &watches, 1);
